...
host_nev = "smtp.gmail.com"
port_nev = 587
username_nev = "xxxxxxx@xx.xx" 						 #Enter your user name eg: nevilpooniwala1997@gmail.com 
password_nev = "xxxxxx"   						 #Enter password
from_email = username_nev
to_list = ["nevilpooniwala1997@gmail.com","xxxx@xxx.xx","xxxx@xx.xx"]	 #Enter email ids which should receive the attendance

url='http://192.168.43.129:8080/shot.jpg'
...
def function2():
	...
	def save_attendance():
		...
		for i, row in enumerate(DATA):
			...
			ws.write(i, j, col)
		wb.save(e2_2.get()+"_"+e1_2.get()+".xls") 			#Spreadsheet

		email_conn = smtplib.SMTP(host_nev, port_nev)
		email_conn.ehlo()
		email_conn.starttls()
		email_conn.login(username_nev, password_nev)
		email_conn.sendmail(from_email, to_list, str(DATA)) 		#Email
		email_conn.quit()
